...
def CEEVAR(logs,const,t,diff,macoeffs,shockvar,orthog,showplot,errorbands):
    ...
    nipa1 = np.loadtxt('C:\Users\Bart\Documents\Macro Programming\Data\CEEdata.txt', delimiter='\t', skiprows=1) #import as tab-delimited data file
